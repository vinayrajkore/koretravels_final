                      ...
                      <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
                        <tr>
                          <td style="background:linear-gradient(135deg, #0d3d35 0%, #1a7a6e 100%);padding:40px 30px;text-align:center;">
                            <img src="https://res.cloudinary.com/g6idhdc9/image/upload/v1786489642/Gemini_Generated_Image_14i2kp14i2kp14i2-removed-bg_sxa2do.png" alt="Kore Travels Logo" style="height:65px;margin-bottom:15px;display:block;margin-left:auto;margin-right:auto;" />
                          ...
                          <table width="500" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
                            <tr>
                              <td style="background:linear-gradient(135deg, #0d3d35 0%, #1a7a6e 100%);padding:30px;text-align:center;">
                                <img src="https://res.cloudinary.com/g6idhdc9/image/upload/v1786489642/Gemini_Generated_Image_14i2kp14i2kp14i2-removed-bg_sxa2do.png" alt="Kore Travels Logo" style="height:50px;margin-bottom:10px;display:block;margin-left:auto;margin-right:auto;" />
                            ...
                            <tr>
                              <td style="padding:35px 30px;text-align:center;">
                                ...
                                <p style="color:#475569;font-size:15px;line-height:1.6;margin-bottom:20px;">We noticed a new login to your Kore Travels account on <strong>${new Date().toLocaleString()}</strong>.</p>
                                ...
                                <a href="http://localhost:5173/mybookings" style="display:inline-block;padding:12px 28px;background-color:#1a7a6e;color:#ffffff;text-decoration:none;border-radius:6px;font-weight:bold;font-size:15px;">Go to Dashboard</a>
                              </td>
                            </tr>
                            <tr>
                      ...
                      <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
                        <tr>
                          <td style="background:linear-gradient(135deg, #0d3d35 0%, #1a7a6e 100%);padding:35px 30px;text-align:center;">
                            <img src="https://res.cloudinary.com/g6idhdc9/image/upload/v1786489642/Gemini_Generated_Image_14i2kp14i2kp14i2-removed-bg_sxa2do.png" alt="Kore Travels Logo" style="height:60px;margin-bottom:15px;display:block;margin-left:auto;margin-right:auto;" />
